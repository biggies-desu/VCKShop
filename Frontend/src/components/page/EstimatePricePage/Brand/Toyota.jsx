...
function Toyota() {
    ...
    useEffect(() => {
        if (selectedModel && selectedYear) {
            const modelId = Toyota.find((car) => car.name === selectedModel)
    ...
    function fetchAllData() {
        const modelId = Toyota.find((car) => car.name === selectedModel)?.models.find((model) => model.year === selectedYear)?.modelId;
        ...
        <>
            ...
            {selectedModel === null ? (
                ...
                <div className="bg-orange-100 pb-60">
                    <div className="flex p-4 ">
                        ...
                        <div className="flex p-4 justify-center items-center w-full">
                            <h1 className="text-3xl font-semibold text-center mb-6">ค้นหารถยนต์จากยี่ห้อ Toyota</h1>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4">
                        {Toyota.map((car, index) => (
                ...
                <div className="flex p-4">
                    ...
                    <div className="flex p-4 justify-center items-center w-full">
                        <h1 className="text-3xl font-semibold text-center mb-6">ค้นหารถยนต์ Toyota รุ่น {selectedModel}</h1>
                    </div>
                </div>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4">
                        {Toyota.find((car) => car.name === selectedModel)?.models.map((model, index) => (
                ...
                <div className="bg-orange-100 mx-auto py-10">
                    <div className="flex p-4">
                        ...
                        <div className="flex p-4 justify-center items-center w-full">
                            <h1 className="text-3xl font-semibold text-center mb-6">ค้นหาจากรถยี่ห้อ Toyota รุ่น {selectedModel} ({selectedYear})</h1>
                        </div>
                    </div>
