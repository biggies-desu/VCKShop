...
function Login()
{
    ...
    <form class="flex items-center justify-center">
        <div class="mt-20">
            <div class="text-center text-3xl mb-5 ">Login</div>
            <div>Username</div>
            ...
            <div class="text-red-600 text-xs mt-3" id="errmsg"></div>
            <div class="items-center justify-between flex">
            <button onClick={loginfunction} id="login" class="text-center rounded-full bg-green-400 text-sm w-2/5 py-2 px-1 mt-4">Login</button>
            <button onClick={registerfunction} id="register" class="text-center rounded-full bg-green-400 text-sm w-2/5 py-2 px-1 mt-4 ">Register</button>                
            </div>
        </div>
    </form>
    </>
