...
function Home() {
  return (
    <>
      <Navbar />
        <div className="bg-cover bg-center text-white py-80 md:py-96 kanit-bold border-4 border-black" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("src/components/image/vckimg.jpg")' }}>
