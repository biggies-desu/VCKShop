...
function Home() {
  return (
    <>
      <Navbar />
      <div className="flex bg-orange-100 border-2 border-black w-auto h-auto kanit-bold">
        <div className="flex items-center text-center lg:text-left md:px-12">
          <div>
            <h1 className="mt-14 font-semibold text-yellow-400 text-stroke-black text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl">วิชัยการยาง <br />
              <span>VCKRacingShop</span>
            </h1>
            <h2 className="mt-14 text-base lg:text-4xl md:text-2xl font-semibold text-cyan-800 dark:text-white mb-14 bg-animate shadow-lg">"สินค้าทุกชิ้นเป็นของใหม่ และรับประกันคุณภาพ ของแท้ 100%"</h2>
            <div className="border-2 border-gray-800 rounded-lg p-4 grid-cols-3 flex justify-center space-x-6 shadow-lg flex-col md:flex-row space-y-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center rounded-lg space-y-4 mt-14 mb-14">
              <Link to="/queue" id="queue" className="mx-4 px-4 py-3 bg-gray-900 text-gray-200 font-semibold rounded hover:bg-gray-800 text-xl">
                จองเข้าใช้บริการ
              </Link>
            ...
            <section className="container py-16 text-center pb-32">
