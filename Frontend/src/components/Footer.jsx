    ...
    <div id="footer" class="container mx-auto text-gray-200">
        <div id="grid" class="grid grid-cols-3 justify-center text-center">
            <div id="fb-page" class="py-4">
                <div class="text-[2vw] font-bold">Facebook Page</div>
                <div class="py-4">
                    <div>
            ...
            <div id="googlemap" class="py-4">
                <div class="text-[2vw] font-bold">Google Map</div>
                <div class="py-4">
            ...
            <div id="contact" class="py-4">
                <div class="text-[2vw] font-bold">ติดต่อสอบถาม
                    <div class="grid grid-rows-4 text-left py-4">
                        <div class="text-[1vw] font-normal">LINE ID : bankchevy</div>
                        <div class="text-[1vw] font-normal">Facebook : วิชัยการยางVCKRacingShop</div>
                        <div class="text-[1vw] font-normal">Tel: 0830123675 BANK</div>
                        <div class="text-[1vw] font-normal">ที่อยู่ : ถ. บางกรวย - กรุงเทพ ตำบลไทรน้อย อำเภอไทรน้อย นนทบุรี 11150</div>
                    </div>
                </div>
            </div>
        </div>
