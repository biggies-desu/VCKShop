...
function Profile()
{
    ...
    useEffect(() => {
        ...
        function editprofile(event) {
            ...
            let valid = true; // Assume everything is valid at first
        
            // Validate firstname
            if (!trimmedFirstname) {
                setErrorFirstName('กรุณากรอกชื่อจริง');
                valid = false;
            }
        
            // Validate lastname
            if (!trimmedLastname) {
                setErrorLastName('กรุณากรอกนามสกุล');
                valid = false;
            }
        
            // Validate telephone
            if (!trimmedTelephone || trimmedTelephone.length !== 10) {
                setErrorPhoneNumber('กรุณากรอกเบอร์โทรศัพท์ให้ถูกต้อง');
                valid = false;
            }
        
            if (!valid) {
                return; // Stop form if validation fails
            }
                ...
                <form className="bg-white p-8 space-y-4">
                    ...
                    <h1 className="text-2xl font-bold mb-4">ตั้งค่าบัญชี</h1>
                        <form className="space-y-6">
                            ...
                            <div className="flex justify-start font-bold">Firstname <span class="text-red-500">*</span></div>
                                <div className="relative">
                                    ...
                                    {errorFirstName && <p className="text-red-500 text-sm mt-2">{errorFirstName}</p>}
                                    </div>
                            <div className="flex justify-start font-bold">Lastname <span class="text-red-500">*</span></div>
                                <div className="relative">
                                    ...
                                    {errorLastName && <p className="text-red-500 text-sm mt-2">{errorLastName}</p>}
                                    </div>
                            ...
                            <div className="flex justify-start font-bold">Telephone <span class="text-red-500">*</span></div>
                            <div className="relative">
                                <input
                                    value={telephone}
                                    type="tel"
                                    ...
                                    if (value.length > 0 && value[0] !== '0') {
                                        value = '0' + value.slice(0, 9); // add 0 in front
                                    }
