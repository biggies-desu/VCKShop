...
function Home() {
  return (
    <>
      <Navbar />
        <div className="bg-cover bg-center text-white py-60 md:py-60 kanit-bold border-4 border-black" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("${import.meta.env.VITE_IMAGE_BASE_URL}/vckimg.jpg")` }}>
