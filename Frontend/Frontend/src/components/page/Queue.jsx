...
function Queue()
{
    ...
    const handleSubmit = (e) => {
        ...
        if (phoneNumber.length !== 10) {
            setErrorPhoneNumber('กรุณากรอกเบอร์โทรศัพท์ให้ครบ 10 หลัก และเริ่มด้วย 0 (0xx-xxx-xxx)');
          } else {
            setErrorPhoneNumber('');
          }
        ...
        if (fullName && phoneNumber.length === 10 && phoneNumber.startsWith('0') && date && time && CarRegistration && (modelId || selectedModel?.value) && province) {
            openModal();
        }
    };
                    ...
                    <div class="md:w-1/2">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                // Make sure the first digit is always 0
                                if (value.length > 0 && value[0] !== '0') {
                                  value = '0' + value.slice(0, 9); // add 0 in front, and limit to 10 digits
                                }
