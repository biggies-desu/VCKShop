...
const sendtoline = async () => {
  console.log("sendtoline")
  try {
    // Check if LINE Access Token is available
    if (!LINE_ACCESSTOKEN) {
    ...
    console.log('Generated Flex Carousel:', flexCarousel);  // Log to check the generated carousel
    ...
    console.log('Bubble Chunks:', bubbleChunks);  // Log to check chunking process
    ...
    for (let i = 0; i < bubbleChunks.length; i += 5) {
      ...
      console.log('Sending LINE API Request:', { messages: messageBatch });
      ...
      const response = await axios.post(
        ...
        { messages: messageBatch },
        {
          ...
          httpsAgent: proxyAgent, // Proxy to avoid Hostinger IP block
          timeout: 10000
        }
      );
...
module.exports.sendtoline = sendtoline;